...
try:
    api_id = int(os.environ.get("TG_API_ID","7523379"))
    api_hash = os.environ.get("TG_API_HASH","ce43762f206dc2a2eb115986fbe3b4a2")
...
tg_bot_token = os.environ.get("TG_BOT_FATHER_TOKEN", "5255818430:AAHWiVqgHgHgT7EtDojkvAVULtwtAuJc-CQ")
